...
export default class MultipleChocieQuestionEdit extends React.Component {
    constructor() {
        super()
    ...
    addOneOption(answer, index) {
        return (
            <div class="input-group" key={index}>
                ...
                <input type="text" class="form-control" placeholder="Option" ref="content" value={answer} onChange={this.onOptionChangeHandle.bind(this, index)}/> {/* <input type="text" class="form-control" placeholder="Option" ref="content" defaultValue={answer}/> */}
                <span class="input-group-addon" onClick={this.onAddImageHandle.bind(this, index)}>
